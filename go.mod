...
require (
	...
	github.com/chainguard-dev/terraform-infra-common v0.3.2
...
require (
	...
	github.com/letsencrypt/boulder v0.0.0-20231221180706-5972d43924a1 // indirect
	...
	golang.org/x/build v0.0.0-20231221184428-1e1849c9c1ed // indirect
